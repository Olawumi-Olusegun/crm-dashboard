        ...
        <>
            <div className="relative p-2 flex flex-col gap-y-3 border rounded-md shadow-xl">
                <div className="flex flex-col lg:flex-row lg:items-center gap-2 ">
                    <h2 className="flex-1 text-sm font-bold text-black/80 mr-5 md:mr-0">
                    ...
                    <div className="flex flex-col gap-1 w-full flex-1 h-2 self-start">
                        ...
                        <div className="w-full shrink-0 bg-gray-200 h-2 rounded-full overflow-hidden flex items-center lg:mr-6">
                            ...
                            <div className="w-[20%] h-2 bg-pink-200 "></div>
                            <div className="w-[10%] h-2 bg-yellow-200 "></div>
                        </div>
                        <div className="flex items-center gap-2 flex-wrap w-full h-5">
                            <div className="flex items-center gap-1">
                                <div className="h-2 w-2 rounded-full shrink-0 bg-green-200 "></div>
                                <span className="text-[9px] text-gray-500">Won $18M</span>
                            </div>
                            <div className="flex items-center gap-1">
                                <div className="h-2 w-2 rounded-full shrink-0 bg-blue-200 "></div>
                                <span className="text-[9px] text-gray-500">Committed $8M</span>
                            </div>
                            <div className="flex items-center gap-1">
                                <div className="h-2 w-2 rounded-full shrink-0 bg-blue-200 "></div>
                                <span className="text-[9px] text-gray-500">Best case $7M</span>
                            </div>
                            <div className="flex items-center gap-1">
                                <div className="h-2 w-2 rounded-full shrink-0 bg-blue-200 "></div>
                                <span className="text-[9px] text-gray-500">Qualified $3M</span>
                            </div>
                            <div className="flex items-center gap-1">
                                <div className="h-2 w-2 rounded-full shrink-0 bg-gray-200 "></div>
                                <span className="text-[9px] text-gray-500">Leads $75M</span>
                            </div>
                        </div>
                    </div>
                </div>
                <div className="w-full transition-all duration-300 overflow-y-hidden" style={{ height: openCard ? cardRef.current?.offsetHeight || 0 : 0 }}>
                    <div ref={cardRef} className="grid grid-cols-12 gap-1 w-full">
